...
class OpenAIEvaluatorLocal(OpenAIEvaluator):
    ...
    def __init__(self,
        ...
        if model_kwargs is None:
            model_kwargs = OpenAIEvaluatorLocal.DEFAULT_MODEL_KWARGS
...
class OpenAIMultiNeedleEvaluator(OpenAIEvaluator):
    DEFAULT_MODEL_KWARGS: dict = dict(temperature=0)
    ...
    def __init__(self,
                 ...
                 question_asked: str = None):
        if model_kwargs is None:
            model_kwargs = OpenAIMultiNeedleEvaluator.DEFAULT_MODEL_KWARGS
        super().__init__(model_name, model_kwargs, true_answer, question_asked)
        ...
        self.evaluator = ChatOpenAI(model=self.model_name,
                                    ...
                                    base_url=base_url,
                                    **self.model_kwargs)
        self.criteria = {'grade': '''You are an expert grader of student answers relative to a reference answer.
